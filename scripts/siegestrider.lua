...
local ruparm, rlarm, rfbarrel1, rfbarrel2, rfflare1, rfflare2 = piece("ruparm", "rlarm", "rfbarrel1", "rfbarrel2", "rfflare1", "rfflare2")z
...
local TORSO_SPEED_YAW = math.rad(220)
...
local function RestorePose()
	...
	Turn(rthigh , x_axis, 0, math.rad(180) )
	Turn(rleg , x_axis, 0, math.rad(180) )
	Turn(lthigh , x_axis, 0, math.rad(180) )
	Turn(lleg , x_axis, 0, math.rad(180) )
