...
local factoryUnitPosDef = {
	...
	factoryhover = {
		...
		hoverheavy      = unitTypes.HEAVY_SOMETHING,
	},
	factorygunship = {
	...
	factorytank = {
		...
		tankskirm        = unitTypes.SKIRMISHER,
	},
	factoryamph = {
	...
	factorysiege = {
	    siegepw          = unitTypes.WEIRD_RAIDER,
	    siegescout       = unitTypes.SKIRMISHER,
		siegecon         = unitTypes.CONSTRUCTOR,
		siegeraid        = unitTypes.RAIDER,
		siegeriot        = unitTypes.RIOT,
		siegeskirm       = unitTypes.ARTILLERY,
		siegeaa          = unitTypes.ANTI_AIR,
		siegeassault     = unitTypes.ASSAULT,
		siegestrider     = unitTypes.HEAVY_SOMETHING,
		siegebomb        = unitTypes.SPECIAL,
		siegemega     = unitTypes.UTILITY,
	},
		factoryquad = {
		walkercon         = unitTypes.CONSTRUCTOR,
	    walkerriot          = unitTypes.WEIRD_RAIDER,
	    walkerskirm       = unitTypes.SKIRMISHER,
		-- siegeraid        = unitTypes.RAIDER,
		walkerdual        = unitTypes.RIOT,
		walkersniper       = unitTypes.ARTILLERY,
		walkeraa         = unitTypes.ANTI_AIR,
		walkerassault     = unitTypes.ASSAULT,
		walkerlaser     = unitTypes.HEAVY_SOMETHING,
		walkerstrider     = unitTypes.SPECIAL,
		walkeremp     = unitTypes.UTILITY,
	},
	factoryarmor = {
	    armordisarm          = unitTypes.WEIRD_RAIDER,
	    armorskirm       = unitTypes.SKIRMISHER,
		armorcon         = unitTypes.CONSTRUCTOR,
		armorraider        = unitTypes.RAIDER,
		armorriot        = unitTypes.RIOT,
		armorarty      = unitTypes.ARTILLERY,
		armoraa          = unitTypes.ANTI_AIR,
		armorfastassault     = unitTypes.ASSAULT,
		armorgrav    = unitTypes.HEAVY_SOMETHING,
		-- siegebomb        = unitTypes.SPECIAL,
		armorvision     = unitTypes.UTILITY,
	},
	pw_bomberfac = {
		bomberriot        = unitTypes.RIOT,
		bomberprec        = unitTypes.ASSAULT,
	...
	pw_dropfac = {
		...
		factorydrone = {
		dronefaccon        = unitTypes.CONSTRUCTOR,
		dronefactorp        = unitTypes.WEIRD_RAIDER,
		dronefacraid      = unitTypes.RAIDER,
		dronefacskirm      = unitTypes.SKIRMISHER,
		dronefactrans      = unitTypes.SPECIAL,
		--gunshipaa         = unitTypes.ANTI_AIR,
		dronefacassault    = unitTypes.ASSAULT,
		--gunshipkrow       = unitTypes.HEAVY_SOMETHING,
		dronefacriot       = unitTypes.RIOT,
	},
}
...
factoryUnitPosDef.platesiege   = Spring.Utilities.CopyTable(factoryUnitPosDef.factorysiege)
factoryUnitPosDef.platequad   = Spring.Utilities.CopyTable(factoryUnitPosDef.factoryquad)
factoryUnitPosDef.platearmor   = Spring.Utilities.CopyTable(factoryUnitPosDef.factoryarmor)
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
