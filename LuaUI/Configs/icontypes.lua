...
-- commanders
 ...
 --------------------------------------------------------------------------------
    factorysiege = {
    bitmap='icons/factorysiege.dds',
    size=2.6,
  },
       platesiege = {
    bitmap='icons/platesiege.dds',
    size=2.15,
  }, 
       siegeraid = {
    bitmap='icons/siegeraid.dds',
    size=1.6,
  }, 
       siegescout = {
    bitmap='icons/siegescout.dds',
    size=1.8,
  }, 
        siegepw = {
    bitmap='icons/siegepw.dds',
    size=1.4,
  },  
          siegeskirm = {
    bitmap='icons/siegeskirm.dds',
    size=1.8,
  },  
          siegeassault = {
    bitmap='icons/siegeassault.dds',
    size=1.65,
  },  
          siegeaa = {
    bitmap='icons/siegeaa.dds',
    size=1.7,
  },  
          siegebomb = {
    bitmap='icons/siegebomb.dds',
    size=1.7,
  },  
          siegestrider = {
    bitmap='icons/siegestrider.dds',
    size=2.0,
  },  
          siegesupport = {
    bitmap='icons/siegesupport.dds',
    size=2.0,
  },  
            siegestrider2 = {
    bitmap='icons/siegestrider2.dds',
    size=2.1,
  },  
          -- siegecon = {
    -- bitmap='icons/siegecon.dds',
    -- size=2.5,
  -- },  
            siegeriot = {
    bitmap='icons/siegeriot.dds',
    size=1.8,
  },  
  ...
  --walkers
              ...
              walkerriot1 = {
    bitmap='icons/walkerriot1.dds',
    size=1.8,
  },
  
                walkerlaser1 = {
    bitmap='icons/walkerlaser1.dds',
    size=2.5,
  },
                walkerskirm1 = {
    bitmap='icons/walkerskirm1.dds',
    size=1.7,
  },
                walkerassault1 = {
    bitmap='icons/walkerassault1.dds',
    size=2.3,
  },
                walkerstrider1 = {
    bitmap='icons/walkerstrider1.dds',
    size=2.4,
  },
              walkerdual1 = {
    bitmap='icons/walkerdual1.dds',
    size=1.8,
  },
                walkersupport1 = {
    bitmap='icons/walkersupport1.dds',
    size=1.8,
  },
                  walkerfac1 = {
    bitmap='icons/walkerfac1.dds',
    size=2.7,
  },
                  walkerplate1 = {
    bitmap='icons/walkerplate1.dds',
    size=2.25,
  },
                    walkerspecial1 = {
    bitmap='icons/walkerspecial1.dds',
    size=1.7,
  },
  
    --truck factory(armor)
	                    truckfac = {
    bitmap='icons/truckfac.dds',
    size=5.0,
  },
  truckvision = {
    bitmap='icons/truckvision.dds',
    size=1.7,
  },
  	                    armorscout = {
    bitmap='icons/armorscout.dds',
    size=1.7,
  },
    	                    armoraa = {
    bitmap='icons/armoraa.dds',
    size=1.7,
  },
  truckskirm = {
    bitmap='icons/truckskirm.dds',
    size=1.7,
  },
  truckplate = {
    bitmap='icons/truckplate.dds',
    size=2.8,
  },
  truckfastassault = {
    bitmap='icons/truckfastassault.dds',
    size=1.7,
  },
  truckraider = {
    bitmap='icons/truckraider.dds',
    size=1.7,
  },
    trucksupport = {
    bitmap='icons/trucksupport.dds',
    size=1.7,
  },
    truckriot = {
    bitmap='icons/truckriot.dds',
    size=2.0,
  },
    truckarty = {
    bitmap='icons/truckarty.dds',
    size=1.8,
  },
      armorgrav = {
    bitmap='icons/armorgrav.dds',
    size=2.2,
  },
  
  --drone factory
      dronefac = {
    bitmap='icons/dronefac.dds',
    size=2.6,
  },
    dronefaccon = {
    bitmap='icons/dronefaccon.dds',
    size=1.9,
  },
      dronefacskirm = {
    bitmap='icons/dronefacskirm.dds',
    size=2.2,
  },
        dronefactorp = {
    bitmap='icons/dronefactorp.dds',
    size=2.1,
  },
          dronefacassault = {
    bitmap='icons/dronefacassault.dds',
    size=2.3,
  },
            dronefactrans = {
    bitmap='icons/dronefactrans.dds',
    size=2.1,
  },
            dronefacraid = {
    bitmap='icons/dronefacraid.dds',
    size=2.0,
  },
              dronefacriot = {
    bitmap='icons/dronefacriot.dds',
    size=2.1,
  },
  --kbots
  kbotjammer = {
  ...
  defenseskirm = {
    ...
    defenseheavyriot = {
    bitmap='icons/defenseheavyriot.dds',
    size=3.0,
  },
  defenseheavy = {
