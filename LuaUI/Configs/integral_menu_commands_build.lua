...
local factory_commands = {
	...
	factorydrone       = {order = 17, row = 3, col = 6},
    factorysiege   = {order = 16, row = 3, col = 2},
	factoryquad  = {order = 13, row = 3, col = 3},
	factoryarmor  = {order = 15, row = 3, col = 1},
...
local econ_commands = {
	...
	staticadvmex      = {order = 11, row = 1, col = 3},
...
local defense_commands = {
	...
	turretheavyriot    = {order = 13, row = 2, col = 6},
