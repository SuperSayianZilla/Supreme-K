...
local factoryDefs = { -- Standard factories
	...
	[UnitDefNames["factorysiege"].id] = 0,
	[UnitDefNames["factoryquad"].id] = 0,
	[UnitDefNames["factoryarmor"].id] = 0,
	...
	[UnitDefNames["platesiege"].id] = 0,
	[UnitDefNames["platequad"].id] = 0,
	[UnitDefNames["platearmor"].id] = 0,
	[UnitDefNames["factorydrone"].id] = 0,
}
