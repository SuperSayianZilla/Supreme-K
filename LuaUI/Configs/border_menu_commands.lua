...
local buildoptions = {
	...
	{-- factories
		...
		{ "factorysiege", notSea=true },
		{ "factoryquad", notSea=true },
		{ "factoryarmor", notSea=true },
		...
		{ "platesiege", notSea=true },
		{ "platequad", notSea=true },
		{ "platearmor", notSea=true },
	...
	{-- economy
		-- common
		{ "staticmex" },
		{ "staticadvmex", tech=2 },--advance mex
		{ "energywind" },-- wind
