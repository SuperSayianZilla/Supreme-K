return { factoryarmor = {
  name                          = [[Truck Factory]],
  description                   = [[Produces armored fighting truck vehicles]],
  ...
  moveState                     = 1,
  noAutoFire                    = false,
  objectName                    = [[legavp.s3o]],
  script                        = [[factoryarmor.lua]],
