return { factorysiege = {
  name                          = [[Siegebot Factory]],
  description                   = [[Produces Heavy Bots]],
  ...
  moveState                     = 1,
  noAutoFire                    = false,
  objectName                    = [[legalab.s3o]],
  script                        = [[siegefactorynew.lua]],
